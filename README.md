...
- Each branch include **individual hands-on work** of a team member
...
| netra     | netra srinivasan | Implemented CUDA Kernels for **Vector Addition**, **Matrix Addition**, **Matrix Transpose**, **Tiled Matrix Transpose**, **Naive MatMul**, **Tiled MatMul** |
| thiru     | thiruselvan vijayakumar   | Implemented Cuda kernels for **matrix addition**, **vector addition**, **matmul**, **matmul with tile** |
| sidd      | samuthraa siddhardh       | Implemented Cuda kernels for **matmul**, **matmul with tile**, **matmul with register** |
